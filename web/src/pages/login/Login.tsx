					...
					<div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
						...
						<form className="mt-8 space-y-5" onSubmit={onSubmit}>
							...
							<a
								...
								className="w-full flex items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3.5 text-sm font-medium text-slate-700 shadow-md transition-all hover:bg-slate-50 hover:shadow-lg hover:border-slate-300 group"
							>
