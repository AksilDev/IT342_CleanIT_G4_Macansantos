        ...
        <div className="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-4">
          ...
          <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
            ...
            <form className="mt-8 space-y-5" onSubmit={onSubmit}>
              ...
              <div>
                ...
                <div className="relative mt-2">
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 pr-10 text-sm text-slate-800 outline-none transition focus:border-violet-500 focus:ring-4 focus:ring-violet-100"
                    required
                  />
                  <button
                    type="button"
              ...
              {/* 🔑 REPLACED <a> with <button> calling Supabase */}
              <button
                type="button"
                onClick={handleGoogleLogin}
                disabled={googleLoading}
                className="w-full flex items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3.5 text-sm font-medium text-slate-700 shadow-md transition-all hover:bg-slate-50 hover:shadow-lg hover:border-slate-300 group disabled:opacity-60"
              >
