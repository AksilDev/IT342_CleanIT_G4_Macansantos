...
import com.G4.backend.features.booking.BookingPhoto;
import com.G4.backend.features.catalog.AddOnRepository;
import com.G4.backend.features.booking.BookingPhotoRepository;
        ...
        try {
            ...
            for (Booking booking : bookings) {
                ...
                if (booking.getTechnicianId() != null) {
                    ...
                    map.put("technicianId", booking.getTechnicianId().toString());
                    
                    // Technician details are included via technicianId
                    map.put("technicianAcceptedAt", booking.getConfirmedAt() != null ? booking.getConfirmedAt().toString() : null);
