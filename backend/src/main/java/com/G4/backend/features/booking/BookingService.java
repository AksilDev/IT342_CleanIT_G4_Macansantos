...
import com.G4.backend.features.booking.BookingException;
import com.G4.backend.features.booking.*;
import com.G4.backend.features.catalog.*;
import com.G4.backend.features.users.*;
...
public class BookingService {
    ...
    public Booking updateBookingStatus(UUID bookingId, BookingStatus newStatus, UUID updatedBy, String reason) {
        ...
        // Idempotent mobile/web retries should not fail after the first update succeeds.
    ...
    private Map<String, Object> createBookingResponseMap(Booking booking, boolean includeAddress) {
        Map<String, Object> map = new HashMap<>();
        map.put("id", booking.getId().toString());
        map.put("bookingCode", booking.getBookingCode());
        map.put("serviceType", booking.getServiceType());
        ...
        map.put("updatedAt", booking.getUpdatedAt() != null ? booking.getUpdatedAt().toString() : null);
        map.put("confirmedAt", booking.getConfirmedAt() != null ? booking.getConfirmedAt().toString() : null);
        map.put("startedAt", booking.getStartedAt() != null ? booking.getStartedAt().toString() : null);
        map.put("completedAt", booking.getCompletedAt() != null ? booking.getCompletedAt().toString() : null);
        map.put("cancelledAt", booking.getCancelledAt() != null ? booking.getCancelledAt().toString() : null);
        map.put("noShowAt", booking.getNoShowAt() != null ? booking.getNoShowAt().toString() : null);
        map.put("photos", getBookingPhotos(booking.getId()));
    ...
    public String validateAddonCompatibility(UUID serviceId, List<UUID> addonIds) {
        ...
        com.G4.backend.features.catalog.Service service = serviceRepository.findById(serviceId)
