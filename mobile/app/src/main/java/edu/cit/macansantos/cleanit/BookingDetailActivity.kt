...
import edu.cit.macansantos.cleanit.adapter.PhotosAdapter
...
class BookingDetailActivity : AppCompatActivity() {
    ...
    private fun displayBookingDetails() {
        booking?.let { b ->
            ...
            tvServiceType.text = b.serviceType
            tvDeviceType.text = b.deviceType.uppercase()
            tvStatus.text = b.status.uppercase()
            tvBookingDate.text = b.bookingDate
            tvTimeSlot.text = b.timeSlot
            tvAddress.text = b.address
            tvLandmark.text = b.landmark ?: "N/A"
            tvSpecialInstructions.text = b.specialInstructions ?: "None"
            tvTotalAmount.text = "₱${String.format("%.2f", b.totalAmount)}"
            tvTechnicianName.text = b.technicianName ?: "Not assigned yet"
            tvCreatedAt.text = b.createdAt
            ...
            val statusMessage = when (b.status.lowercase()) {
            ...
            val canManage = b.status.lowercase() in listOf("pending", "confirmed")
        ...
        booking?.let { b ->
            ...
            lifecycleScope.launch {
                try {
                    ...
                    val response = RetrofitClient.instance.cancelBooking(b.id, request)
            ...
            lifecycleScope.launch {
                try {
                    val request = mapOf(
                        ...
                        "newBookingDate" to newDate,
                        "newTimeSlot" to newTimeSlot,
                        "reason" to reason
                    )
                    val response = RetrofitClient.instance.rescheduleBooking(b.id, request)
